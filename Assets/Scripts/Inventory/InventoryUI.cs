...
public class InventoryUI : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        RefreshUI(); //esta es importante, sin esta linea no aparec�a el inventario despu�s de comprar. Puede parecer redundante pero si no no funciona.
    }
    ...
    void Update()
    {
        ...
        {
            // Si el click NO est� sobre el men� lo cerramos, porque si no no hay otra forma de quitarlo y se queda en pantalla
    ...
    public void OnItemClicked(ItemData item)
    {
        ...
        {
            // Aqu� evitamos combinar el mismo objeto
    ...
    // Buscamos si los objetos est�n uno en la lista de combinables del otro
    ...
    // Si lo eest�n, quitamos los dos items que hemos combinado y ponemos el nuevo
